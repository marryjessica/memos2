import { CopyIcon, Edit3Icon, ExternalLinkIcon, MessageSquarePlusIcon, TrashIcon } from "lucide-react";
  ...
  return (
    <>
      ...
      <DropdownMenu open={contextMenuOpen} onOpenChange={setContextMenuOpen}>
        ...
        <DropdownMenuContent align="start" side="right" sideOffset={0} alignOffset={0}>
          {/* Edit */}
          {!readonly && (
