...
export type Memo = Message<"memos.api.v1.Memo"> & {
  ...
  /**
   * Optional. Timer tracking information.
   *
   * @generated from field: optional memos.api.v1.Memo.TimerData timer = 21;
   */
  timer?: Memo_TimerData;
};
 ...
 *
 * @generated from message memos.api.v1.Memo.TimerData
 */
export type Memo_TimerData = Message<"memos.api.v1.Memo.TimerData"> & {
  /**
   * @generated from field: int64 accumulated_seconds = 1;
   */
  ...
  /**
   * @generated from field: int64 last_start_timestamp = 3;
   */
  lastStartTimestamp: bigint;
};

/**
 * Describes the message memos.api.v1.Memo.TimerData.
 * Use `create(Memo_TimerDataSchema)` to create a new message.
 */
export const Memo_TimerDataSchema: GenMessage<Memo_TimerData> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 1, 1);
